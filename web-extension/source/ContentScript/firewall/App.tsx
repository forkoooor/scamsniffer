...
import { CheckResponse } from "./shared/types";
import CheckDialog from "./SecurityCheck/index"
...
export default function AlertDialog({ firewall }: { firewall: ListenAble }) {
  ...
  useEffect(() => {
    ...
    const doCheck = async () => {
      ...
      try {
        ...
        allResults = checkResults.filter(_ => _);
        if (hasIssues.length) {
